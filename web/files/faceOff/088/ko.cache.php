...
$layout_info->menu->FNB->php_file = "./files/cache/menu/".$vars->FNB.".php";
 $layout_info->header_script = '<script src="https://lab.alexcican.com/set_cookies/cookie.js" type="text/javascript" ></script>
<script>
jQuery(document).ready(function(){
  ...
  if(jQuery.cookie(\'sval\') == \'HamoniKR-ME_Support\'){
    ...
    jQuery(\'.header.main .logo-item a\').attr(\'href\', \'/?support=HamoniKR-ME_Support\');
...
//  jQuery(\'.header_wrap\').remove();
  ...
  // 자동로그인 제거
  jQuery(\'#keepid_opt\').parent(\'label\').remove();
