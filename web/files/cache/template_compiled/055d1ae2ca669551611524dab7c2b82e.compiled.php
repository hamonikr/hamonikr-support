<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/ncart/skins/digital/css/style.css--><?php $__tmp=array('modules/ncart/skins/digital/css/style.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/ncart/skins/digital/css/cartitems.css--><?php $__tmp=array('modules/ncart/skins/digital/css/cartitems.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/ncart/skins/digital/css/btn.css--><?php $__tmp=array('modules/ncart/skins/digital/css/btn.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/ncart/skins/digital','header.html') ?>
<div id="cartitems" class="<?php echo $__Context->module_info->colorset ?>">
	...
	<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/ncart/skins/digital','_header.html') ?>
...
if($__Context->list&&count($__Context->list))foreach($__Context->list as $__Context->no=>$__Context->val){ ?><tr>
	...
	<div class="command">
		<a href="#" class="nuribtn red large" onclick="progressOrderItems('<?php echo $__Context->login_chk ?>'); return false;"><span><?php echo $__Context->lang->cmd_order ?></span></a>
	</div>
</div>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/ncart/skins/digital','footer.html') ?>
<script>
