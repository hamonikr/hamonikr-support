<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/nproduct/skins/shopping/css/btn.css--><?php $__tmp=array('modules/nproduct/skins/shopping/css/btn.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<!--#Meta:modules/nproduct/skins/shopping/css/itemlist.css--><?php $__tmp=array('modules/nproduct/skins/shopping/css/itemlist.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/nproduct/skins/shopping/css/_style.grid.css--><?php $__tmp=array('modules/nproduct/skins/shopping/css/_style.grid.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!-- <!--#Meta:modules/nproduct/skins/shopping/css/button.css--><?php $__tmp=array('modules/nproduct/skins/shopping/css/button.css','','','');Context::loadFile($__tmp);unset($__tmp); ?> -->
<style>
.product_list .item-table { border-radius: 10px; overflow: hidden; }
.product_list .item-table tr th { background-color: rgb(238, 238, 238); border-bottom: 1px solid #bbbbbb; font-family: 굴림; font-size: 15px; color: rgb(51, 51, 51); font-weight: bold; }
</style>
...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/nproduct/skins/shopping','header.html') ?>
<?php if($__Context->module_info->category_display!='N'){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/nproduct/skins/shopping','categorylist.html');
} ?>
...
<div id="itemlist" class="<?php echo $__Context->module_info->colorset ?>">
	<form class="list_header">
		...
		<ul class="display_style">
			<li><a href="<?php echo getUrl('listStyle','list') ?>"><img src="/modules/nproduct/skins/shopping/img/icon_list.gif" /></a></li>
			<li><a href="<?php echo getUrl('listStyle','grid') ?>"><img src="/modules/nproduct/skins/shopping/img/icon_grid.gif" /></a></li>
			<li>
			...
			<?php if($__Context->module_info->display_cart_buttons != 'N'){ ?>
				<li><a class="nuribtn <?php echo $__Context->btn_color ?> medium" href="#" onclick="addItemsToCart();"><span><?php echo $__Context->lang->cmd_add_cart ?></span></a></li>
				<li><a class="nuribtn <?php echo $__Context->btn_color ?> medium" href="#" onclick="addItemsToFavorites();"><span><?php echo $__Context->lang->cmd_add_favorites ?></span></a></li>
			<?php } ?>
		</ul>
	</form>
	<div class="product_list">
		<?php if($__Context->listStyle=='list'){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/nproduct/skins/shopping','_style.list.html');
} ?>
		<?php if($__Context->listStyle=='grid'){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/nproduct/skins/shopping','_style.grid.html');
} ?>
	</div>
	<?php if($__Context->module_info->display_cart_buttons != 'N'){ ?><div class="btn_bottom">
		<a class="nuribtn <?php echo $__Context->btn_color ?> medium" href="#" onclick="addItemsToCart(); return false;"><span><?php echo $__Context->lang->cmd_add_cart ?></span></a>
		<a class="nuribtn <?php echo $__Context->btn_color ?> medium" href="#" onclick="addItemsToFavorites(); return false;"><span><?php echo $__Context->lang->cmd_add_favorites ?></span></a>
	</div><?php } ?>
	<div class="search">
...
<input class="btsbtn default_btn" onclick="location.href='/'" type="button" value="뒤로가기" style="background-color: rgb(52, 152, 219);" />
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/nproduct/skins/shopping','footer.html') ?>
