<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/nmileage/tpl/js/modinstlist.js--><?php $__tmp=array('modules/nmileage/tpl/js/modinstlist.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<tbody>
    ...
    <tr>
        ...
        <td><a href="<?php echo getUrl('act','dispNmileageAdminInsertModInst','module_srl',$__Context->val->module_srl) ?>"><span><?php echo $__Context->lang->cmd_management ?></span></a></td>
...
<div class="clear">
    <div class="fr">
        <a href="<?php echo getUrl('act','dispNmileageAdminInsertModInst','module_srl','') ?>" class="btn"><span><?php echo $__Context->lang->cmd_make ?></span></a>
    </div>
</div>
<!-- page navigation -->
