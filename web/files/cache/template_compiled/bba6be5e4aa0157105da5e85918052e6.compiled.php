...
<?php Context::addJsFile("modules/ncart/ruleset/insertModInst.xml", FALSE, "", 0, "body", TRUE, "") ?><form class="x_form-horizontal" action="./" method="post" enctype="multipart/form-data" ><input type="hidden" name="error_return_url" value="<?php echo htmlspecialchars(getRequestUriByServerEnviroment(), ENT_COMPAT | ENT_HTML401, 'UTF-8', false) ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" /><input type="hidden" name="ruleset" value="insertModInst" />
	...
	<section class="section">
		<h1><?php echo $__Context->lang->basic_setting ?></h1>
		...
		<div class="x_control-group">
			<label class="x_control-label" for=""><?php echo $__Context->lang->module_category ?></label>
			<div class="x_controls">
		...
		<div class="x_control-group">
			<label class="x_control-label" for=""><?php echo $__Context->lang->browser_title ?></label>
			<div class="x_controls">
		...
		<div class="x_control-group">
			<label class="x_control-label" for=""><?php echo $__Context->lang->layout ?></label>
			<div class="x_controls">
		...
		<div class="x_control-group">
			<label class="x_control-label" for=""><?php echo $__Context->lang->skin ?></label>
			<div class="x_controls">
				<select name="skin">
		...
		<div class="x_control-group">
			<label class="x_control-label" for=""><?php echo $__Context->lang->payment_module ?></label>
			<div class="x_controls">
				<select name="epay_module_srl">
					<option value=""<?php if(!$__Context->module_info->epay_module_srl){ ?> selected="selected"<?php } ?> ><?php echo $__Context->lang->cmd_select ?></option>
					<?php if($__Context->epay_modules&&count($__Context->epay_modules))foreach($__Context->epay_modules as $__Context->key=>$__Context->val){ ?><option value="<?php echo $__Context->val->module_srl ?>"<?php if($__Context->module_info->epay_module_srl==$__Context->val->module_srl){ ?> selected="selected"<?php } ?> ><?php echo $__Context->val->browser_title ?></option><?php } ?>
				</select>
				<a href="#epay_module_srl_help" class="x_icon-question-sign" data-toggle><?php echo $__Context->lang->help ?></a>
				<p id="epay_module_srl_help" class="x_help-block" hidden><?php echo $__Context->lang->about_payment_module ?><a href="<?php echo getUrl('','module','admin','act','dispEpayAdminEpayList') ?>" target="_blank"><?php echo $__Context->lang->payment_module_management ?></a></p>
			</div>
		</div>
		<div class="x_control-group">
			<label class="x_control-label" for=""><?php echo $__Context->lang->address_selection ?></label>
			<div class="x_controls">
				<select name="display_delivdest">
					<option value="N"<?php if($__Context->module_info->display_delivdest == 'N'){ ?> selected="selected"<?php } ?>><?php echo $__Context->lang->notuse ?></option>
					<option value="Y"<?php if($__Context->module_info->display_delivdest == 'Y'){ ?> selected="selected"<?php } ?>><?php echo $__Context->lang->use ?></option>
				</select>
				<a href="#display_delivdest_help" class="x_icon-question-sign" data-toggle><?php echo $__Context->lang->help ?></a>
				<p id="display_delivdest_help" class="x_help-block" hidden><?php echo $__Context->lang->about_address_selection ?></p>
			</div>
		</div>
		<div class="x_control-group">
			<label class="x_control-label" for=""><?php echo $__Context->lang->delivery_fee_payment ?></label>
			<div class="x_controls">
				<select name="display_delivfee">
					<option value="N"<?php if($__Context->module_info->display_delivfee == 'N'){ ?> selected="selected"<?php } ?>><?php echo $__Context->lang->notuse ?></option>
					<option value="Y"<?php if($__Context->module_info->display_delivfee == 'Y'){ ?> selected="selected"<?php } ?>><?php echo $__Context->lang->use ?></option>
				</select>
				<a href="#display_delivfee_help" class="x_icon-question-sign" data-toggle><?php echo $__Context->lang->help ?></a>
				<p id="display_delivfee_help" class="x_help-block" hidden><?php echo $__Context->lang->about_delivery_fee_payment ?></p>
			</div>
		</div>
	</section>
	<section class="section">
