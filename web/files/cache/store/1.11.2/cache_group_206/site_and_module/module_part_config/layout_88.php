...
return 'O:8:"stdClass":1:{s:13:"header_script";s:1333:"<script src="http://lab.alexcican.com/set_cookies/cookie.js" type="text/javascript" ></script>
<script>
jQuery(document).ready(function(){
  ...
  if(url.searchParams.get("support") != null) {
    $.cookie(\'sval\', url.searchParams.get("support"), { expires: 2147483647, path: \'/\'});
  }

  if($.cookie(\'sval\') == \'HamoniKR-ME_Support\'){
