...
return 'O:8:"stdClass":1:{s:13:"header_script";s:2313:"<script src="https://lab.alexcican.com/set_cookies/cookie.js" type="text/javascript" ></script>
<script>
jQuery(document).ready(function(){
  ...
  if(url.searchParams.get("support") != null) {
    ...
    jQuery(\'.header.main .logo-item a\').attr(\'onclick\', "location.href=\'/?support=HamoniKR-ME_Support\'");
  ...
  if(jQuery.cookie(\'sval\') == \'HamoniKR-ME_Support\'){
    ...
    jQuery(\'.header.main .logo-item a\').attr(\'onclick\', applinkurl);
