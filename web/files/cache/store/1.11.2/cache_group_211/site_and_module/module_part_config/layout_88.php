...
return 'O:8:"stdClass":1:{s:13:"header_script";s:1363:"<script src="http://lab.alexcican.com/set_cookies/cookie.js" type="text/javascript" ></script>
<script>
jQuery(document).ready(function(){
  ...
  if(jQuery.cookie(\'sval\') == \'HamoniKR-ME_Support\'){
    ...
    for(var i=0; i < idx_bt.lengt ;++i){
      if(idx_bt[i]) idx_bt[i].attr(\'onclick\', \'location.href="/?support=HamoniKR-ME_Support"\');
    }
  }
