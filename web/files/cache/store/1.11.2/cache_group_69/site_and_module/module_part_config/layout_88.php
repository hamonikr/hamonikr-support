...
return 'O:8:"stdClass":1:{s:13:"header_script";s:634:"<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
<script>
...
console.log(\'1\');
  ...
  jQuery(\'#itemlist .small.blue.nuribtn\').on(\'click\', function(){
      add_item(function(){ window.location.href=\'cart\'; console.log(\'2\');});
  });
});
</script>";}';