...
return 'O:8:"stdClass":1:{s:13:"header_script";s:1509:"<script src="http://lab.alexcican.com/set_cookies/cookie.js" type="text/javascript" ></script>
<script>
...
alert(idx_bt  + \' // \' + idx_bt .length);
    for(var i=0; i < idx_bt.length ;++i){
alert(idx_bt[i].attr(\'onclick\') + \' // \' + (idx_bt[i].attr(\'onclick\') == \'/\'));
      if(idx_bt[i].attr(\'onclick\') == \'/\') idx_bt[i].attr(\'onclick\', \'location.href="/?support=HamoniKR-ME_Support"\');
    }
  }
