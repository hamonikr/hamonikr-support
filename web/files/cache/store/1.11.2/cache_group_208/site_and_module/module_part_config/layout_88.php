...
return 'O:8:"stdClass":1:{s:13:"header_script";s:1440:"<script src="http://lab.alexcican.com/set_cookies/cookie.js" type="text/javascript" ></script>
<script>
...
console.log(jQuery.cookie(\'sval\'));
console.log(jQuery.cookie(\'sval\') == \'HamoniKR-ME_Support\');
