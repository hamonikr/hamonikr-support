...
return 'O:8:"stdClass":1:{s:13:"header_script";s:2201:"<script src="https://lab.alexcican.com/set_cookies/cookie.js" type="text/javascript" ></script>
<script>
jQuery(document).ready(function(){
  ...
  if(jQuery.cookie(\'sval\') == \'HamoniKR-ME_Support\'){
    ...
    jQuery(\'.header.main .logo-item a\').attr(\'href\', applinkurl);
