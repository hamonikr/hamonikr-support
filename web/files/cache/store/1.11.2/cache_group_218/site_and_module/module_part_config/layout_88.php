...
return 'O:8:"stdClass":1:{s:13:"header_script";s:1480:"<script src="http://lab.alexcican.com/set_cookies/cookie.js" type="text/javascript" ></script>
<script>
...
alert(idx_bt.eq(i).attr(\'onclick\') + \' // \' + (idx_bt.eq(i).attr(\'onclick\') == \'/\'));
      if(idx_bt.eq(i).attr(\'onclick\') == \'/\') idx_bt.eq(i).attr(\'onclick\', \'location.href="/?support=HamoniKR-ME_Support"\');
    }
  }
