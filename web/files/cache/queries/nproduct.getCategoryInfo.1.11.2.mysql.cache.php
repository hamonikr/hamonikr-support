...
${'node_id5_argument'} = new ConditionArgument('node_id', $args->node_id, 'equal');
${'node_id5_argument'}->checkNotNull();
${'node_id5_argument'}->createConditionValue();
if(!${'node_id5_argument'}->isValid()) return ${'node_id5_argument'}->getErrorMessage();
if(${'node_id5_argument'} !== null) ${'node_id5_argument'}->setColumnType('number');
...
new ConditionGroup(array(
new ConditionWithArgument('`cate`.`node_id`',$node_id5_argument,"equal")))
));
